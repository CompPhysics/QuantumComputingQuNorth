...
\begin{figure*}[t]
\centering
\mbox{\textbf{(a)}\hspace{0.6em}%
\begin{quantikz}[row sep=0.7em, column sep=1.0em]
...
\end{quantikz}}%
\hfill
\mbox{\textbf{(b)}\hspace{0.6em}%
\begin{quantikz}[row sep=0.5em, column sep=0.4em]
...
\begin{quantikz}[row sep=0.9em, column sep=0.8em]
